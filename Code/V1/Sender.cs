...
//        private readonly string _endpoint = "https://fcm.googleapis.com/fcm/send";
        ...
        public Sender(string serverKey, HttpClient httpClient = null, JsonSerializerSettings serializerSettings = null, string projectId = null)
        {
            ...
            _endpoint = $"https://fcm.googleapis.com/v1/projects/{projectId}/messages:send";
